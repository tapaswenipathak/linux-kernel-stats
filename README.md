...
### Data Directory
The Data directory contains all the data generated by the linux-kernel-stats project. It also contains data regarding number of commits, number of lines of code changed and removed, drivers used, information related to drivers etc.
